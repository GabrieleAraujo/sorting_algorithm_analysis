...
for algorithm in algorithms:
    ...
    for case in ['best', 'average', 'worst']:
        ...
        plt.plot(df_case['n'], df_case['tempo'], marker='o', label=f'{case} case')
    plt.title(f'Performance do {algorithm}')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'{algorithm}_performance.png', bbox_inches='tight')
    plt.show()
...
#         plt.plot(df_case['n'], df_case['tempo'], marker='o', label=f'{algorithm} - {case}')
...
# plt.legend()
# plt.grid(True)
# plt.savefig('comparison_performance.png', bbox_inches='tight')
...
#     plt.plot(df_case['n'], df_case['tempo'], marker='o', label=f'{algorithm} - best')
...
# plt.legend()
# plt.grid(True)
# plt.savefig('comparison_performance_best.png', bbox_inches='tight')
...
#     plt.plot(df_case['n'], df_case['tempo'], marker='o', label=f'{algorithm} - average')
...
# plt.legend()
# plt.grid(True)
# plt.savefig('comparison_performance_average.png', bbox_inches='tight')
...
#     plt.plot(df_case['n'], df_case['tempo'], marker='o', label=f'{algorithm} - worst')
...
# plt.legend()
# plt.grid(True)
# plt.savefig('comparison_performance_worst.png', bbox_inches='tight')
