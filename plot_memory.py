...
for algorithm in algorithms:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'plot\{algorithm}_memory.png', bbox_inches='tight')
    plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig('plot\comparison_memory.png', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('plot\comparison_memory_best.png', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('plot\comparison_memory_average.png', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('plot\comparison_memory_worst.png', bbox_inches='tight')
